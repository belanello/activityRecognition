...
The final model was constructed with 500 trees, at each split of each tree 2 predictors were bootstrapped among all the predictors as split candidates. We use this model to predict classes of the test set that we haven't used yet.
```{r test}
