...
g <- g + geom_point(aes(x=idx,y=Fold5),
                    col='steelblue')+geom_line(aes(x=idx,y=Fold5),
                                               col='steelblue')
g <- g + geom_point(aes(x=idx,y=Fold6),
                    col='steelblue')+geom_line(aes(x=idx,y=Fold6),
                                               col='steelblue')
g <- g + geom_point(aes(x=idx,y=Fold7),
                    col='steelblue')+geom_line(aes(x=idx,y=Fold7),
                                               col='steelblue')
g <- g + geom_point(aes(x=idx,y=Fold8),
                    col='steelblue')+geom_line(aes(x=idx,y=Fold8),
                                               col='steelblue')
...
accMdl2 <- mean(mdl2$test$predicted==tempTest$classe)
...
mean(predict(mdl3)==train$classe)
mean(predict(mdl3,test)==test$classe)
